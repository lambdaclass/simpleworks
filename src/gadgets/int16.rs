...
mod tests {
    ...
    fn test_addition_with_positive_operands() {
        ...
        let result_from_primitive_var =
            Int16::new_witness(ark_relations::ns!(cs, "result"), || Ok(primitive_result)).unwrap();
        let addend_var =
            Int16::new_witness(ark_relations::ns!(cs, "addend"), || Ok(primitive_addend)).unwrap();
        let augend_var =
            Int16::new_witness(ark_relations::ns!(cs, "augend"), || Ok(primitive_augend)).unwrap();
