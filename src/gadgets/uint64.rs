...
#[cfg(test)]
mod tests {
    use crate::{gadgets::{UInt64Gadget, ConstraintF, traits::BitRotationGadget}};
    ...
    fn test_one_left_rotation() {
        ...
        let byte = UInt64Gadget::new_witness(cs.clone(), || Ok(0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000)).unwrap();
    ...
    fn test_more_than_one_right_rotation() {
        ...
        assert!(cs.is_satisfied().unwrap());
        assert_eq!(expected_byte, result.value().unwrap());
        assert_eq!(result.value().unwrap(), 0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000);
    }
}
